...
@Component({
  selector: 'app-watch-header',
  templateUrl: './watch-header.component.html',
  styleUrls: ['./watch-header.component.css']
})
export class WatchHeaderComponent implements OnInit {
